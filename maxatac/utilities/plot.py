...
def plot_attention_weights(
    model, transformer_names, data_sample, num_heads, file_location, use_rpe
):
    """
...
def plot_ism_results(superseq, bases_of_interest, save_dirs):
    ...
    for i, base_of_interest in enumerate(bases_of_interest):
        seq = superseq[i]
        base_dict = {b: seq[:, i] for i, b in enumerate(bases)}
        ...
        # Plot stuff
        fig, ax = plt.subplots(
            nrows=3, ncols=1, figsize=(35, 8), sharex=True, constrained_layout=True
        )
